<template>
  <div class="app-container">
    <div class="filter-container">
      <span style="color:#606266;padding:5px;font-size:20px">查询对象:</span>
      <el-select
      ...
      <span style="color:#606266;padding:5px;font-size:20px">查询信息:</span>
      <el-input
...
<iframe src="http://localhost:9527/testmap.html" width="100%" height="1000px"  frameborder="0" scrolling="no" ></iframe>
